...
data class User(
    ...
    val preferredDestinations: List<String> = emptyList(), // 선호 여행지
    ...
    val recruitPosts: List<String> = emptyList(), // 내가 모집한 글 (Post ID만 저장)
    val applications: List<String> = emptyList(), // 내가 지원한 글 (Application ID만 저장)
