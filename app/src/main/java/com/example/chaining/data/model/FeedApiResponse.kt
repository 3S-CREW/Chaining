...
data class TourItem(
    @SerializedName("addr1") val address: String,          // 주소
    @SerializedName("title") val title: String,            // 관광지명
    @SerializedName("firstimage") val imageUrl: String?,   // 대표 이미지 URL
    @SerializedName("contentid") val contentId: String     // 콘텐츠 ID
)